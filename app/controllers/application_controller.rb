class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.permit(:accept_invitation, keys: [:photo, :first_name, :last_name, :date_of_birth,
                                      :pronouns, :address, :street, :zipcode, :city, :country, :summary, :travelling,
    ...
    devise_parameter_sanitizer.permit(:account_update, keys: [:photo, :first_name, :last_name, :date_of_birth, :pronouns,
                                      :address, :street, :zipcode, :city, :country, :summary, :travelling, :offers_couch,
